# -*- coding: utf-8 -*-
"""
Created on Sat Dec  7 11:12:27 2024
    ...
    for target_lag_option in ['without_lag', 'with_lag']:
        for econ_lag_option in ['no_econ', 'with_econ', 'with_econ_lag']:
            ...
            param_grid = {
                ...
                'max_depth': [7,10,15],  # Max depth of tree
               'min_samples_split': [10,15,20],  # Min samples to split an internal node
                'min_samples_leaf': [20,25,30 ],  # Min samples required to be at a leaf node
...
metrics_df.to_excel("C:/Users/vertt/Desktop/walk_forward_rf_metrics_with_features.xlsx", index=False)
